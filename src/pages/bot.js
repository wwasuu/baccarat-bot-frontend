              ...
              <Card.Group itemsPerRow={4}>
                {
                  ...
                  <>
                  <Card header={bet.current.bot} description={bet.current.shoe + '-' + bet.current.round} />
                  <Card header="56.45%" description="โอกาสทำกำไร" />
                  </>:
                  <>
                  <Card header={"กำลังวิเคราะห์"} description={"โต๊ะน่าเล่น"} />
              ...
              <Table celled inverted selectable>
                ...
                <Table.Body>
                {
                  ...
                  <>
                    ...
                    <Table.Cell>{Object.keys(element.bet.data.credit)[0]}</Table.Cell>
